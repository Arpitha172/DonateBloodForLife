...
def donor_dashboard_view(request):
    ...
    #chatgpt
    latest_poster = EventPoster.objects.order_by('-created_at').first()
    dict['latest_poster'] = latest_poster # Add the poster to the context
    #end
...
def view_event_poster(request):
    poster = EventPoster.objects.order_by('-created_at').first()
    return render(request, 'donor/event_poster.html', {'poster': poster})
